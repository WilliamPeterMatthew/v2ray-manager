...
![Docker Pulls](https://img.shields.io/docker/pulls/petermatthew/v2ray-debian)
![Docker Image Size](https://img.shields.io/docker/image-size/petermatthew/v2ray-debian)
![Docker Image Version](https://img.shields.io/docker/v/petermatthew/v2ray-debian)
...
Clone this repo.
```bash
git clone https://github.com/WilliamPeterMatthew/v2ray-manager.git -b v2ray-debian
```
