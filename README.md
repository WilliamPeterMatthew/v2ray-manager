# v2ray-manager-debian
A webpage to manage v2ray

![Docker Pulls](https://img.shields.io/docker/pulls/petermatthew/v2ray-manager-debian)
![Docker Image Size](https://img.shields.io/docker/image-size/petermatthew/v2ray-manager-debian)
![Docker Image Version](https://img.shields.io/docker/v/petermatthew/v2ray-manager-debian)
